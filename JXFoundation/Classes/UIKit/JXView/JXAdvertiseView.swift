...
public class JXAdvertiseView: UIView {
    ...
    public override func layoutSubviews() {
        ...
        self.enterButton.frame = CGRect(x: UIScreen.main.bounds.width - buttonWidth - rightMargin, y: UIScreen.main.isIphoneX ? 44 : 20, width: buttonWidth, height: buttonWidth)
    }
