...
//        layout.footerReferenceSize = UICollectionViewFlowLayoutAutomaticSize
        ...
        collectionView.register(UINib(nibName: "VideoContentCell", bundle: nil), forCellWithReuseIdentifier: reuseIdentifierItem)
...
//        }
    ...
    func collectionView(_ collectionView: UICollectionView, cellForItemAt indexPath: IndexPath) -> UICollectionViewCell {
        let cell = collectionView.dequeueReusableCell(withReuseIdentifier: reuseIdentifierItem, for: indexPath) as! VideoContentCell
...
//        cell.statusView.isHidden = true
    ...
    func collectionView(_ collectionView: UICollectionView, viewForSupplementaryElementOfKind kind: String, at indexPath: IndexPath) -> UICollectionReusableView {
        if kind == UICollectionView.elementKindSectionHeader {
            ...
            reusableView.hotIconImageView.image = UIImage(named: "home_video_video")
            reusableView.hotTitleImageView.image = UIImage(named: "home_video_hotTitle")
            reusableView.moreLabel.text = "更多热门"
            return reusableView
        } else {
            ...
            reusableView.footerButton.setTitle("进入短片", for: .normal)
