...
class JXTestView: JXPresentView {
      ...
      public class func initWithTitle(_ title: String?, content: String?, cancelTitle: String = "", confirmTitle: String) -> JXTestView {
          
          guard let alert = Bundle.init(for: self).loadNibNamed("JXTestView", owner: nil, options: nil)?.last as? JXTestView else {
