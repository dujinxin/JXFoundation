//
//  JXlandscapeRightViewController.swift
...
class JXlandscapeRightViewController: JXTableViewController {
...
extension JXlandscapeRightViewController {
    ...
    func tableView(_ tableView: UITableView, didSelectRowAt indexPath: IndexPath) {
        ...
        case 0:
            self.navigationController?.pushViewController(JXlandscapeRightViewController(), animated: true)
        case 1:
            let vc = JXPortraitViewController()
            self.navigationController?.pushViewController(vc, animated: true)
        case 2:
            let vc = JXNavigationController(rootViewController: JXlandscapeRightViewController())
